...
const uint16_t PROGMEM HUE[] = {LALT_T(KC_S), RALT_T(KC_L), COMBO_END};
const uint16_t PROGMEM CHROMA[] = {KC_X, KC_DOT, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
  ...
  COMBO(HUE, LT(1,KC_NO)),
  COMBO(CHROMA, LT(2,KC_NO)),
  COMBO(OZ_BASE, DF(BASE)),
  COMBO(GAME_BASE, DF(BASE)) };