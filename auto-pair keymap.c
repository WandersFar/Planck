...
void q_finished(tap_dance_state_t *state, void *user_data) {
	...
	switch (qtap_state.state) {
		...
		case TD_1H: register_code16(U_QUOTE); break;
...
void q_reset(tap_dance_state_t *state, void *user_data) {
	switch (qtap_state.state) {
		case TD_1T: break;
		case TD_1H: unregister_code16(U_QUOTE); break;
		case TD_2T: break;
		case TD_2H: break;
		case TD_NONE: break; }
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_ortho_4x12(KC_F12, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,
		...
		U_QUOTE, RGB_RMOD, RGB_SAD, RGB_HUD, C(KC_PGUP), RGB_VAD, RGB_VAI, C(KC_PGDN), RGB_HUI, RGB_SAI, RGB_MOD, RCS(KC_ESC)),
