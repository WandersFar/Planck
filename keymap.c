...
const uint16_t PROGMEM TAB_BACKWARD[] = {KC_Z, KC_X, COMBO_END};
const uint16_t PROGMEM TAB_PREVIOUS[] = {KC_X, KC_C, COMBO_END};
const uint16_t PROGMEM TAB_NEXT[] = {KC_COMM, KC_DOT, COMBO_END};
const uint16_t PROGMEM TAB_FORWARD[] = {KC_DOT, KC_SLSH, COMBO_END};
...
const uint16_t PROGMEM VOLUME_UP[] = {LALT_T(KC_S), RALT_T(KC_L), COMBO_END};
const uint16_t PROGMEM VOLUME_DOWN[] = {LGUI_T(KC_A), RGUI_T(KC_SPC), COMBO_END};
...
const uint16_t PROGMEM SCROLL_LEFT[] = {LGUI_T(KC_A), LALT_T(KC_S), COMBO_END};
const uint16_t PROGMEM SCROLL_RIGHT[] = {RALT_T(KC_L), RGUI_T(KC_SPC), COMBO_END};
combo_t key_combos[COMBO_COUNT] = {
  ...
  COMBO(TAB_BACKWARD, RCS(KC_PGUP)),
  COMBO(TAB_PREVIOUS, C(KC_PGUP)),
  COMBO(TAB_NEXT, C(KC_PGDN)),
  COMBO(TAB_FORWARD, RCS(KC_PGDN)),
