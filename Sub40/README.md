...
*master 8 pin 5x3 matrix = RJ45 = slave 8 pin Japanese columnar duplex, rotary tap + 2 spin pins: 30 keys, 1 knob, 16 combos (+ 6 oz), 2 layers*
...
*master 11 pin 6x3 matrix, rotary tap + 2 spin pins = RJ45 = slave 8 pin Japanese columnar duplex, rotary tap + 2 spin pins*
***
