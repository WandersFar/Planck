...
*30 keys, 1 knob, 22 combos (14 base + 2 exit + 6 oz), 2 layers, left master 8 pin matrix = RJ45 = right slave 8 pin Japanese columnar duplex including rotary tap and spins*
